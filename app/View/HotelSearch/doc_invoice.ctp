<?php
   ...
   $first_name = $HotelData['travellers']['first_name'];
   $last_name = $HotelData['travellers']['last_name'];
   $mobile_no = $HotelData['travellersDetails']['mobile_no'];
   $email_id = $HotelData['travellersDetails']['email_id'];
   ...
   $data   .=  '<tr><td align="left"><p style="font-size:10px;margin:0;"><b>Booking Id:</b> '.$bookingid.'</p><p style="font-size:10px;margin:0;"><b>Date:</b> '.date('d-m-Y').'</p></td><td></td></tr>';
   $data   .=  '<tr><td colspan="2" height="20px" style="line-height:0;"></td></tr><tr><td style="padding:0;" align="left"><h4 style="font-size:14px;margin:0;">Customer Information:</h4></td><td align="right" style="padding:0;"></td></tr><tr><td colspan="2" height="10px" style="line-height:0;"></td></tr><tr><td align="left"><p style="font-size:10px;margin:0 0 5px 0;"><b>Name:</b> '.$first_name.'</p><p style="font-size:10px;margin:0 0 5px 0;"><b>Phone No:</b>'.$mobile_no.'</p><p style="font-size:10px;margin:0 0 5px 0;"><b>Email Id:</b> '.$email_id.'</p></td></tr><tr><td colspan="2" height="20px" style="line-height:0;"></td></tr><tr><td align="left" colspan="2"><h4 style="font-size:12px;margin:0 0 5px 0;">Stay Details:</h4></td></tr><tr><td align="left" height="10px" colspan="2"></td></tr>';
   ...
   $invoice_num = $bookingid.'_invoice';
   ...
   header("Location:".$siteUrlfront."HotelSearch/sendIdInvoice/".$userInvoice.'/'.$bookingid);
   exit;
   ?>