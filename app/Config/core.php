 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9miSoncoya');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496749683645Soncoya');

    /*Payment gateway */
	Configure::write('merchant_id', '213014');
	Configure::write('working_key', '673378C8BA556301F5FB214204C09051');
	Configure::write('access_code', 'AVUG02GD63AS86GUSA');
	Configure::write('redirect_url', 'downloaddocument');
	Configure::write('cancel_url', 'cancel');
	Configure::write('pagecount', 10);
