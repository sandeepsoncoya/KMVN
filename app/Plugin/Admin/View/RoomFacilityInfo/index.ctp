        ...
        <?php
            echo $this->Html->link(
                ...
                [
                    ...
                    'data-action'=>'room_facilities_info_form',
                    'data-model'=>'RoomFacilityInfo'
...
<input type="hidden" value="room_facility_info_listing" id="action"/>
<input type="hidden" value="RoomFacilityInfo" id="model"/>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">   
