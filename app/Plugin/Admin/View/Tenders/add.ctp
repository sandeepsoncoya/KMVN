   ...
   <div class="col-lg-12">
      <div class="card">
         <div class="card-header bg-info">
            <h4 class="m-b-0 text-white">Add Tender</h4>
         </div>
         <?php echo $this->Form->create('Tenders', ['type' => 'file']); ?>
         <?php 
            if($id > 0): 
            ...
            <div class="card-body">
               ...
               <div class="row">
                  <?php
                     ...
                     if(isset($this->data['Tenders']['file']) && $this->data['Tenders']['file']!=""){
                       
                        $filePath = Configure::read('RelativeUrl').'tenders/';
                        $fileNameFeatured = $this->data['Tenders']['file'];                                   
                        if(file_exists($filePath.$fileNameFeatured)){
                            $fileExistFeatured =  true;                                       
                            $fileAbsolutePathFeatured = Configure::read('AbsoluteUrl').'tenders/'.$fileNameFeatured;
                        }
                     }
                     ?>
